...
#define GAMEMOVEMENT_LJUMP_DELAY			0.6f		// seconds
...
// For sanity checking getting stuck on CMoveData::SetAbsOrigin
	...
	bool IsLongJumping() { return m_bIsLongJumping; }
...
protected:
	...
	virtual void	OnLand(float fVelocity) { m_bIsLongJumping = false; }
