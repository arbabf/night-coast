...
protected:
	...
	bool					m_bHasLongJumped;
	bool					m_bLongJumpExpired;
public:
	DECLARE_DATADESC();
	DECLARE_SERVERCLASS();
	...
	void					SetSuitLongJump(bool isTrue){ m_bHasLongJumped = isTrue; }
	void					SetLongJumpExpired(bool isTrue) { m_bLongJumpExpired = isTrue; }
	bool					IsLongJumping(void) { return m_bHasLongJumped; }
	bool					IsLongJumpExpired(void){ return m_bLongJumpExpired; }
...
public:
	...
	void	SetLongJump(bool bLongJump) { m_bCanLongJump = bLongJump; }
