...
CBasePlayer::CBasePlayer( )
{
	...
	m_bCanLongJump = false;
	m_bLongJumpExpired = false;
	m_bHasLongJumped = false;
	m_nNumMorphineCount = 0;
...
void CBasePlayer::UpdateClientData( void )
{
	...
	// update morphine count THIS TOOK ME SIX FUCKING HOURS TO FIND
	m_Local.m_nNumMorphineCount = m_nNumMorphineCount;
