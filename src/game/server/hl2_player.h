...
public:
	...
	bool CanWalk(void) { return m_bWalkEnabled; }
	void EnableWalk(bool bEnable);

	void SetMovement(bool eEnable);
...
private:
	...
	bool				m_bWalkEnabled;			// Used to disable walking temporarily for item_energymodule.
	...
	float				m_fTurnOffEnergyPoint; // When to switch off energy module.
